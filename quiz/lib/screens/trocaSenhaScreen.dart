    ...
    if (e is FirebaseAuthException) {
      switch (e.code) {
        case 'user-not-found':
          ...
          break;
        case 'invalid-email':
          errorMessage = 'Formato de e-mail inválido. Por favor, tente novamente.';
          break;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: corDestaque()),
          onPressed: () => Navigator.of(context).pop(),
        ),
        title: Text(
          'Esqueci a senha',
          style: TextStyle(color: corDestaque(), fontWeight: FontWeight.normal),
        ),
        centerTitle: true,
      ),
      body: Container(
