...
import 'package:quiz/screens/mainMenuScreen.dart';

class Verificaloginscreen extends StatelessWidget {
  final Function toggleTheme;

  const Verificaloginscreen({super.key, required this.toggleTheme});
        ...
        if (snapshot.hasData) {
          ...
          return FutureBuilder<void>(
            ...
            builder: (context, futureSnapshot) {
              ...
              return MainMenuScreen(toggleTheme: toggleTheme,);
            },
          );
  ...
  Future<void> _checkUserAccess(BuildContext context) async {
    try {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(builder: (context) => Login(toggleTheme: toggleTheme,)),
      );
    }
  }
}